...
本仓库 **Snap.Hutao.Rev** 是一个基于 Snap Hutao 的个人维护版本，并非全新独立开发的工具箱。

- 基础功能主要来自：
  - https://github.com/wangdage12/Snap.Hutao
- 注入相关组件由本项目独立维护，用于学习研究和兼容性测试。

本项目是我基于 Snap Hutao 进行功能扩展后的学习性实践版本。
...
1. **本项目仅是合并产物**
   - 主体功能与后续可用性，本质上依赖 Snap Hutao 上游是否持续维护与更新。

2. **与原作者无关联**
   - 本项目的合并行为仅出于学习与技术研究目的。
   - 本项目与 Snap Hutao 原作者及其仓库 **没有合作、授权背书或运营关系**。
...
> 若你需要稳定、可持续维护的主体功能体验，请优先关注并支持 Snap Hutao 上游仓库。
